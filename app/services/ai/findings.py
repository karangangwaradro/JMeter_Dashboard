#!/usr/bin/env python3
"""
findings.py — Structured Performance Findings Generator.

Produces structured Finding objects (F-001, F-002, ...) with evidence chains,
interpretations, and linked Recommendations from test data.
Core intelligence layer that drives inline AI observations throughout reports.
"""
