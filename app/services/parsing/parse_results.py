...
class ResultParsingService:
    ...
    def parse_timeseries(self, tool: ToolType, raw_data: Any, test_id: str) -> TimeSeriesResult:
        ...
        if tool == ToolType.JMETER:
            ...
            return blazemeter_timeseries_parser.parse_timeseries(raw_data, test_id)
